    ...
    <section id="contact" className="bg-gray-50 py-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          Haben Sie Fragen oder möchten Sie Ihren Empfang umgestalten? Kontaktieren Sie unser Team noch heute.
          </p>
        </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md mb-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800">Büro</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800">Geschäftszeiten</h4>
                    <p className="text-gray-600">
